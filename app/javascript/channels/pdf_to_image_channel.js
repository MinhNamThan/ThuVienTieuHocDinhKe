...
const channel = consumer.subscriptions.create("PdfToImageChannel", {
  ...
  received(data) {
    ...
    if (bookId == responseContent.doc_id) {
      ...
      console.log($("#converted-page-number").attr("data-last-uploaded-book-id"));
      ...
      if(percentage == 100) {
        ...
        window.location.replace("/admin/books/" + responseContent.doc_id);
      }
    }
  }
});
